...
def analyze_movie(movie_path):
    ...
    try:
        ...
        return None, None, None, None, None, None, state.ERR_BAD_RESOLUTION
    ...
    return ub_data, ub_data_enemy, time_data, total_damage, debuff_value, damage_list, status
...
def analyze_ub_frame(frame, roi, time_min, time_10sec, time_sec, ub_data, ub_data_enemy, ub_data_value, damage_list, characters_find, tmp_damage, past_id, past_count):
    ...
    Args
        ...
        damage_list (list): damage data
        characters_find (list): founded characters
        tmp_damage (list): damage number list
